...
type DashboardData struct {
	...
	RecentFamilies           []store.ListRecentFamiliesRow
}
...
func NewDashboardService(db *store.Queries) *DashboardService {
	return &DashboardService{db: db}
}

func (s *DashboardService) GetWeeklyActivity() ([]store.GetWeeklyTaskCompletionStatsRow, error) {
